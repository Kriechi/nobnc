...
option(FEATURE_SASL "Enable SASL support" ON)
if(FEATURE_SASL)
    find_package(Sasl2)
    if(SASL2_FOUND)
...
cmake_dependent_option(HAVE_SASL "Enable SASL support" ON "FEATURE_SASL;SASL2_FOUND" OFF)
mark_as_advanced(HAVE_SASL)
