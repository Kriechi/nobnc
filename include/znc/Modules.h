...
public:
    ...
    bool operator<(const CModInfo& Info) const { return (GetName() < Info.GetName()); }
...
public:
     ...
     */
    virtual EModRet
    OnModuleLoading(const CString& sModName, const CString& sArgs, CModInfo::EModuleType eType, bool& bSuccess, CString& sRetMsg);
