...
NoString No::escape(const NoString& str, No::EscapeFormat to)
{
    return No::escape(str, No::AsciiFormat, to);
}

NoString No::escape(const NoString& str, No::EscapeFormat from, No::EscapeFormat to)
{
    NoString ret;
